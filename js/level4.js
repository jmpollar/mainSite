...
var yOffset = 0;
//initialize timer
var timerNew4 = new easytimer.Timer();
...
$('.tab').click(function () {
  ...
  if (tabId === 'tab6') {
    ...
    timerNew4.start();
    timerNew4.addEventListener('secondsUpdated', function (e) {
      timeParagraph4.html("TIME: " + timerNew4.getTimeValues().toString());
    })
...
function drawSluggy() {
  ...
  imageEl.on('click', function () {
    ...
    //pause the timer
    timerNew4.pause();
    timeParagraph4.html("FINAL TIME: " + timerNew4.getTimeValues().toString());
