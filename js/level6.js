...
$('.tab').click(function () {
  ...
  if (tabId === 'tab8') {
    ...
    imageEl.click(function () {
      //pause the timer
      timerGlobal.pause();
      timeParagraph6.html("FINAL TIME: " + timerGlobal.getTimeValues().toString());
  });
...
function drawSluggy() {
  ...
  imageEl.on('click', function () {
    ...
    $("#location6").append("<button class=tab data-tab=tab9 id=buttons><b>Next Level</b> (Double Click)</button>");
