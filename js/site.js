...
class SlugGame extends Phaser.Scene {
  //constructor (PHASER)
  constructor() {
    super({ key: 'MainGameScene' }); //key is to refer to this scene later
  }
  ...
  preload() {
    ...
    this.load.image("slugBase", "../img/slug_base.png");
    this.load.image("slug1", "../img/slug1.jpg");
    this.load.image("textImg", "../img/text.PNG");
    this.load.image("backgroundImage", "../img/photo1.png");
    this.load.image("trees", "../img/trees.jpg");
  }
...
/*
  ...
  update(time, delta) {
    ...
    $("#time-p").html("TIME ELAPSED: " + (this.timeElapsed / 1000) + " SECONDS");
...
game.scene.add("Boot", SlugGame, true);
