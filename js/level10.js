...
$('.tab').click(function () {
  ...
  if (tabId === 'tab12') {
    ...
    timerNew10.addEventListener('secondsUpdated', function (e) {
      timeParagraph10.html("TIME: " + timerNew10.getTimeValues().toString());
    })
...
function drawSluggy() {
  ...
  imageEl.on('click', function () {
    ...
    $("#location10").append("<button class=tab data-tab=tab13 id=buttons>Next Level (double click me)</button>");
